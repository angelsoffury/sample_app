  ...
  window.BookManage = {
    ...
    renderDiscount: function(discount, prepend) {
      ...
      html.find(".editDiscount").click((function(_this) {
        return function() {
          var date, day, e, field, form, i, id, j, len, len1, month, ref, ref1, ref2, year;
          ...
          try {
            ...
            ref = ["code", "amount_in_dollars", "percent", "limit"];
            ...
            ref1 = [date.getMonth() + 1, date.getDate() + 1, date.getFullYear()], month = ref1[0], day = ref1[1], year = ref1[2];
...
(function() {
  window.Book = {
    ...
    getChapter: function(slug, offset) {
      var chapter, clean_title, ref;
      if (slug == null) {
        slug = (ref = window.location.pathname.match(RegExp(this.path + "\\/(.*?)$"))) != null ? ref[1] : void 0;
      }
        ...
        return function(result) {
          ...
          $.each(xmlDoc.getElementsByTagName("a"), function(index, a) {
            ...
            if (href = a.getAttribute('href')) {
              if (URI(href).host() === "" && ((ref1 = a.getAttribute('class')) != null ? ref1.match(/hyperref/) : void 0)) {
...
(function() {
  window.Purchase = {
    ...
    submitForm: function() {
      ...
      if (((ref = $("#purchaseEmail").val()) != null ? ref.trim() : void 0) !== ((ref1 = $("#purchaseEmailConfirmation").val()) != null ? ref1.trim() : void 0)) {
